...
export default function IdleStatus() {
  ...
  return (
    <div suppressHydrationWarning className="fixed bottom-4 right-4 bg-black/80 text-white p-3 rounded-lg text-xs font-mono z-50 border border-gray-600 lg:block">
