      ...
      <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <div className="px-2 pr-14">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Please review the employee details before onboarding. Are you sure you want to proceed?
          </p>
        </div>
        <div className="flex flex-col">
            ...
            <div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">{employeeData.email}</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="mt-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded p-3 space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900 dark:text-white">{employeeData.personal_email}</span>
                  </div>
                  <div className="flex justify-between">
          ...
          <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
            ...
            >
              {isSaving ? 'Onboarding...' : 'Confirm Onboard'}
            </Button>
          </div>
        </div>
      </div>
